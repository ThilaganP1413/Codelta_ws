...
def generate_launch_description():
    ...
    # Setup project path
    pkg_project_description = get_package_share_directory('delta_gz_sim_cpp')
    pkg_ros_gz_sim = get_package_share_directory('ros_gz_sim')

    # Load the SDF file from "description" package
    sdf_file  =  os.path.join(pkg_project_description, 'descriptions', 'robot_world.sdf')
    ...
    bridge = Node(
        ...
        parameters=[{
            'config_file': os.path.join(pkg_project_description, 'configs', 'ros_ign_sim.yaml'),
